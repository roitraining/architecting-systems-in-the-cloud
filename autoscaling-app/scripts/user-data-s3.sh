...
# Downloads and installs the Image Processing app from S3

# Update system and install dependencies
yum update -y
yum install -y python3 python3-pip unzip nginx
...
aws s3 cp s3://BUCKET_NAME/autoscaling-app.zip . --region us-east-1

# Extract application files
unzip autoscaling-app.zip
cd src
...
Type=simple
User=ec2-user
WorkingDirectory=/opt/image-processor/src
